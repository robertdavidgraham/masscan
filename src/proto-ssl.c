...
static const char ssl_response[] = 
...
ssl_selftest(void)
{
    ...
    unsigned bannerx_offset = 0;
    struct Banner1 *banner1;
    struct Banner1State state[1];
    unsigned ii;
    ...
    ssl_parse(  banner1,
                0,
                state,
                (const unsigned char *)ssl_response,
                sizeof(ssl_response),
                bannerx,
                &bannerx_offset,
                sizeof(banner)
    ...
    banner1 = banner1_create();
    memset(state, 0, sizeof(state));
    for (ii=0; ii<sizeof(ssl_response); ii++)
    ssl_parse(  banner1,
                0,
                state,
                (const unsigned char *)ssl_response+ii,
                1,
                banner,
                &banner_offset,
                sizeof(banner)
